...
function ProductScreen({ match, history }) {
  ...
  return (
    <div>
      <Link to="/" className="btn btn-light my-3" variant="secondary">
        بازگشت
      </Link>
      {loading ? (
        <Loader />
            ...
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <Rating
                  ...
                  text={`     از   ${product.numReviews}   بازخورد`}
                  color={'#f8e825'}
                ></Rating>
              </ListGroup.Item>

              <ListGroup.Item>
                قیمت : {`${convertNumberToPersian(product.price)} تومان`}
              </ListGroup.Item>
